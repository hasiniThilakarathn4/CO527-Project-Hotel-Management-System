        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Add the User name ,Password and the position</h4>
                                        </div>
										<form method="post">
										...
										<div class="modal-body">
                                            ...
                                            <input name="newr1"  class="form-control" placeholder="Enter Position">
                                            </div>
                                        </div>
						...
						if(isset($_POST['in']))
						{
                            ...
                            $newr1 = $_POST['newr1'];
                            if(strlen($newps)<8){
                                echo '<script language="javascript" type="text/javascript">alert("Your password is not strong enough")</script>';
                            }else{
							
							$newsql ="Insert into login (usname,pass,roles) values ('$newus','$newps','$newr1')";

							if(mysqli_query($con,$newsql))
							{
							echo' <script language="javascript" type="text/javascript"> alert("User name,password and role added") </script>';
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<div class="modal-body">
                                            ...
                                            <input name="role" value="<?php echo $r1; ?>" class="form-control" placeholder="Enter Position">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				...
				if(isset($_POST['up']))
				{
					...
					$upsql = "UPDATE `login` SET `usname`='$usname','roles'='$role',`pass`='$passwr' WHERE id = '$id'";
					if(mysqli_query($con,$upsql))
					{
					echo' <script language="javascript" type="text/javascript"> alert("User name,password and position update") </script>';
