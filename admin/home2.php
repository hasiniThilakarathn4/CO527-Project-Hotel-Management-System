        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home2.php"><i class="fa fa-dashboard"></i> Status</a>
                    </li>
					<li>
                        <a href="roombook2.php"><i class="fa fa-bar-chart-o"></i> Room Booking</a>
                    </li>
                    <li>
                        <a href="payment2.php"><i class="fa fa-qrcode"></i> Payment</a>
                    </li>
                    <li>
                        <a href="log.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
									...
									{	
										...
										if($co=="Conform")
										{
											echo"<tr>
												...
												<th><a href='roombook2.php?rid=".$trow['id']." ></a></th>
												</tr>";
										}	
